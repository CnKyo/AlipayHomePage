...
NSString *const MBT_RefreshHeaderIdleText = @"下拉可以返回商品信息";
NSString *const MBT_RefreshHeaderPullingText = @"松开立即返回商品信息";
NSString *const MBT_RefreshHeaderRefreshingText = @"正在返回商品信息";
