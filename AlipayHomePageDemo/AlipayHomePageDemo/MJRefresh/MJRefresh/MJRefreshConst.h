...
UIKIT_EXTERN NSString *const MBT_RefreshHeaderIdleText;
UIKIT_EXTERN NSString *const MBT_RefreshHeaderPullingText;
UIKIT_EXTERN NSString *const MBT_RefreshHeaderRefreshingText;
